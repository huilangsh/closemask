...
→ CloseMask masks: "Search for user with ID [ID_CARD_1]"
→ LLM generates: tool_call({function: "search", args: {id: "[ID_CARD_1]"}})
...
→ LLM streams: "Here's info about [BANK_CARD_1]..."
...
Turn 2: User says "Update my ID to 110101199003077777"
         → Same ID → Same placeholder [ID_CARD_1]
...
{
  "output": {
    "text": "My ID is __PII_ID_CARD_00000001__",
