...
→ CloseMask 遮罩: "搜索身份证号为 ${ID_CARD_a1b2c3} 的用户"
→ LLM 生成: tool_call({function: "search", args: {id: "${ID_CARD_a1b2c3}"}})
...
→ CloseMask 遮罩账户号码
→ LLM 流式返回: "关于 ${BANK_CARD_xxx} 的信息如下..."
